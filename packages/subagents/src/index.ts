/**
 * Subagents — spawn background subagents on pi or Claude Code, unified behind
 * a single Effect service interface.
 *
...
import { SubagentManager, type SubagentManagerShape } from "./manager.ts";
import {
