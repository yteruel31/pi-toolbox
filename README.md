...
In-progress private Tailnet MCP Apps gateway with a lazy Streamable HTTP client, OAuth, and non-destructive Tailscale Serve management. MCP App hosting is not implemented yet.
