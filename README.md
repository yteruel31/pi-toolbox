...
In-progress private Tailnet MCP Apps gateway foundation with lazy, non-destructive Tailscale Serve management. MCP client and App hosting support are not implemented yet.
