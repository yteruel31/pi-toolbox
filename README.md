...
In-progress private Tailnet MCP Apps gateway with a lazy Streamable HTTP client and non-destructive Tailscale Serve management. OAuth and App hosting are not implemented yet.
